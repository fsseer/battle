...
INSERT INTO "new_Character" ("agi", "ap", "apUpdatedAt", "createdAt", "fate", "id", "int", "level", "luck", "name", "sta", "str", "userId") SELECT "agi", "ap", "apUpdatedAt", "createdAt", "fate", "id", "int", "level", "luck", "name", "sta", "str", "userId" FROM "Character";
