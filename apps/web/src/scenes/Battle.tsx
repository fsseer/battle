...
import { Sprite } from '@pixi/react-legacy'
        ...
        <div className="parchment" style={{ marginTop: 8 }}>
          ...
          <div style={{ border: '1px solid #ddd', borderRadius: 8, overflow: 'hidden' }}>
            <Stage width={360} height={200} options={{ background: 0xf7f1e1 }}>
              ...
              />
              <Sprite
                image={'/sprites/fighter_blue.svg'}
                x={260 + cam.x}
                y={88 + cam.y}
                width={64}
                height={64}
              ...
              {particles.map((p, idx) => (
                <Sprite
                  ...
                  height={6}
                  anchor={0.5}
                  alpha={Math.max(0.1, p.life / p.ttl)}
                />
              ))}
              {/* 스윙 트레일 */}
              {trail && trail.t > 0 && (
                <Sprite
                  ...
                  height={4}
                  anchor={0}
                  alpha={Math.max(0, trail.t / trail.ttl)}
                />
              )}
            </Stage>
          </div>
