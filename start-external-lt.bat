...
rem Internet-access dev: expose via LocalTunnel
rem - Server on 5174 with CORS_ORIGIN=*
rem - Web build + preview on 5173
rem - Tunnels for both web/api
...
echo [server] Start dev on :5174 (CORS_ORIGIN=*)
